...
from model_batchsize import FullyConvolutionalNetwork, GRUDecoder, reshape_fcn_output
from train_batch import MathExpressionDataset, collate_fn, compute_wer_detailed, make_5ch_from_image_gpu
...
class AttentionVisualizer:
    ...
    def visualize_attention_on_image(self, image_path, output_dir, sample_name):
        ...
        # ✅ FIXED: Use make_5ch_from_image_gpu from train_batch
    ...
    def analyze_attention_patterns(self, dataloader, output_dir, num_samples=50):
        ...
        for batch_idx, batch in enumerate(dataloader):
            ...
            images = batch['images'].to(self.device)
            targets = batch['targets']  # ✅ List of tensors
            labels = batch['labels']
...
def main():
    ...
    # Configuration
    DATA_DIR = r"C:\Users\kani1\Desktop\IE643\custom-dataset\ProcessedMathWrittingSymbols"
    TEST_CSV = r"C:\Users\kani1\Desktop\IE643\custom-dataset\ProcessedMathWrittingSymbols\test_database.csv"
    WORD2IDX_PATH = r"C:\Users\kani1\Desktop\IE643\custom-dataset\ProcessedMathWrittingSymbols\word2idx.pkl"
    IDX2WORD_PATH = r"C:\Users\kani1\Desktop\IE643\custom-dataset\ProcessedMathWrittingSymbols\idx2word.pkl"
    BASE_IMAGE_DIR = r"C:\Users\kani1\Desktop\IE643\custom-dataset\ProcessedMathWrittingSymbols\test"
    CHECKPOINT_PATH = r"C:\Users\kani1\Downloads\checkpoint_best (4).pth"
    OUTPUT_DIR = 'visualizations_symbols_batch'
